...
export function DatePicker({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          `fixed bottom-0 z-10 left-1/2 -translate-x-1/2 max-w-[375px] w-full ${
            allowRangeSelection ? "h-5/6" : "h-3/4"
          } bg-elevation-50 p-3 transition-transform duration-300 ease-in-out rounded-t-2xl justify-center`,
                ...
                <div className="grid grid-cols-9 text-sm">
                  <div className="col-span-4">
                    <div className="h-[46px] py-3 px-4 w-full bg-[#f6f2e7] border border-gray-200 rounded-lg truncate">
                      {current.from &&
                        formatDateShort(current.from, lang.locale)}
                    </div>
                  </div>
