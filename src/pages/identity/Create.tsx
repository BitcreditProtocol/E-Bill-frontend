  ...
  return (
    <div className="flex-1 flex flex-col gap-11">
      <div className="flex flex-col items-center gap-2">
        <Title>
          <FormattedMessage
            id="identity.create.requiredData.title"
            defaultMessage="Personal identity"
            description="Title for the required data step"
          />
        </Title>
        <Description className="text-center mx-14">
          <FormattedMessage
            id="identity.create.requiredData.description"
            defaultMessage="Please enter this required data to join the Bitcredit network"
            description="Description for the required data step"
          />
        </Description>
      </div>
...
export default function Create() {
  ...
  >(CreationFormSteps.REQUIRED_DATA);
